...
export default function HowItWorksModal(props: HowItWorksModalProps) {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-2xl overflow-hidden bg-white border border-slate-200 rounded-2xl shadow-2xl flex flex-col max-h-[90vh]">
        {/* Header */}
        <div className="flex items-center justify-between p-5 border-b border-slate-100 bg-slate-50">
          ...
          <button
            ...
            className="p-1 px-1.5 rounded-lg border border-slate-200 bg-white hover:bg-slate-100 text-slate-500 hover:text-slate-800 transition-colors"
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          <p className="text-sm text-slate-600 leading-relaxed">
            ...
            <strong className="text-slate-900"> mandatory human review</strong> step.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl border border-blue-100 bg-blue-50/50">
              ...
              <h3 className="font-semibold text-slate-900 mt-2">Policy Framing</h3>
            ...
            <div className="p-4 rounded-xl border border-teal-100 bg-teal-50/50">
              ...
              <h3 className="font-semibold text-slate-900 mt-2">Search Grounding</h3>
              <p className="text-xs text-slate-600 mt-1">
            ...
            <div className="p-4 rounded-xl border border-indigo-100 bg-indigo-50/50">
              ...
              <h3 className="font-semibold text-slate-900 mt-2">Multi-Metric Simulation</h3>
              <p className="text-xs text-slate-600 mt-1">
          ...
          <div className="p-4 rounded-xl border border-emerald-100 bg-emerald-50/50">
            ...
            <h3 className="font-semibold text-slate-900 mt-2">Briefing & Human-in-the-Loop Override</h3>
            <p className="text-xs text-slate-600 mt-1 leading-relaxed">
              Agent 5 organizes a plain-language proposal brief. Finally, step 6 locks all outputs until a <strong className="text-slate-900 font-semibold">human official reviews, edits, and justifies</strong> the final policy decision to commit it to the Decision Memory.
            </p>
          </div>
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50 flex gap-3">
            ...
            <div className="text-xs text-slate-600 leading-relaxed">
               <span className="font-semibold text-slate-900 block mb-1">AI-Assisted · Human-Decided</span>
